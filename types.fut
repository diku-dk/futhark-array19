...
type point_projected = {x: i32, y: i32, x_orig: f32, y_orig: f32, z: f32}
type point_2d = {x: i32, y: i32}
type point_2d_with_interpolation = {x: i32, y: i32, z: f32, x_orig: f32, y_orig: f32}

type line = {y: i32, x1: i32, x2: i32, z1: f32, z2: f32, x_orig1: f32, x_orig2: f32, y_orig1: f32, y_orig2: f32}
...
type slope_point = {x: i32, z: f32, x_orig: f32, y_orig: f32}
type slope = {x: f32, z: f32, x_orig: f32, y_orig: f32}
