...
type point_projected = {x: i32, y: i32, x_orig: f32, y_orig: f32, z_orig: f32, z: f32}
...
type slope_point = {x: i32, z: f32, x_orig: f32, y_orig: f32, z_orig: f32}
type slope = {x: f32, z: f32, x_orig: f32, y_orig: f32, z_orig: f32}
